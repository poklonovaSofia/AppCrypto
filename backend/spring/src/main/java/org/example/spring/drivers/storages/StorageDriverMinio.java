...
public class StorageDriverMinio implements StorageDriverInterface
{
    ...
    public void delete(String urlPath, String bucketName) {
        try {
            ...
            URI fileUri = new URI(urlPath);
            String objectPath = fileUri.getPath().substring(1); // Remove leading '/'
            String objectName = objectPath.replaceFirst("^files/", "");
        ...
        } catch (MinioException | URISyntaxException | IOException | InvalidKeyException | NoSuchAlgorithmException e) {
